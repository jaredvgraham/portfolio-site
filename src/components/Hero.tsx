                ...
                <div className="mx-auto text-center  w-1/4 md:w-1/2  max-h-80 overflow-scroll scrol">
                  ...
                  >
                    <p className="text-slate-300">
                      I'm Jared, a frontend developer with a habit of creating
                      full-stack applications using Next.js. My expertise lies
                      in both frontend and backend development, allowing me to
                      craft seamless, dynamic, and high-performance web
                      applications. I have a strong passion for creating
                      visually appealing and user-friendly interfaces that are
                      not only functional but also aesthetically pleasing. My
                      proficiency in modern web technologies and my ability to
                      implement AI solutions using APIs like ChatGPT make me a
